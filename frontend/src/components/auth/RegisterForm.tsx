      ...
      <div className="bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-neutral-800 font-inter">
            Daftar Akun SmartWealth
          </h2>
          <p className="text-neutral-600 mt-2">
            Mulai kelola keuangan Anda dengan lebih pintar
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-neutral-600">
            Sudah punya akun?{' '}
            <button className="text-primary-500 hover:text-primary-600 font-semibold" onClick={onShowLogin}>Masuk</button>
          </p>
        </div>
      </div>
    </div>
